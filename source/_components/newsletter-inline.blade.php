<div x-data="newsletter()" x-init="init()" class="bg-gray-800 mt-8 py-4 text-center text-white">
    <form action="https://api.convertkit.com/v3/forms/2046384/subscribe" method="post" class="max-w-3xl mx-auto px-3">
        ...
        <div class="flex items-end mt-3 mx-auto space-x-2 w-3/4">
            ...
            <button @click.prevent="submit()" :disabled="isLoading" class="w-2/6 py-1 bg-gray-600 rounded-2xl text-white">
